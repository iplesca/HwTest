...
/**
 * Base static class for performing query and update operations on the 'cities' table.
 *
 * Cities table
 *
...
abstract class BaseCityPeer
{
    ...
    protected static $fieldNames = array (
        ...
        BasePeer::TYPE_COLNAME => array (CityPeer::ID, CityPeer::NAME, ),
    ...
    protected static $fieldKeys = array (
        ...
        BasePeer::TYPE_COLNAME => array (CityPeer::ID => 0, CityPeer::NAME => 1, ),
    ...
    public static function clearInstancePool($and_clear_all_references = false)
    {
      ...
      {
        foreach (CityPeer::$instances as $instance)
        {
    ...
    /**
     * Method to invalidate the instance pool of all tables related to cities
    ...
    public static function doDeleteAll(PropelPDO $con = null)
    {
        ...
        try {
            ...
            $con->beginTransaction();
            $affectedRows += CityPeer::doOnDeleteCascade(new Criteria(CityPeer::DATABASE_NAME), $con);
     ...
     */
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        try {
            ...
            $c = clone $criteria;
            $affectedRows += CityPeer::doOnDeleteCascade($c, $con);
    ...
    protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
    {
        ...
        foreach ($objects as $obj) {
            ...
            $criteria->add(VisitedCityPeer::CITYID, $obj->getId());
