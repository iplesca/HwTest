...
abstract class BaseUserPeer
{
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Firstname', 'Lastname', 'Gender', 'Age', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'firstname', 'lastname', 'gender', 'age', ),
        BasePeer::TYPE_COLNAME => array (UserPeer::ID, UserPeer::FIRSTNAME, UserPeer::LASTNAME, UserPeer::GENDER, UserPeer::AGE, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'FIRSTNAME', 'LASTNAME', 'GENDER', 'AGE', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'firstname', 'lastname', 'gender', 'age', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Firstname' => 1, 'Lastname' => 2, 'Gender' => 3, 'Age' => 4, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'firstname' => 1, 'lastname' => 2, 'gender' => 3, 'age' => 4, ),
        BasePeer::TYPE_COLNAME => array (UserPeer::ID => 0, UserPeer::FIRSTNAME => 1, UserPeer::LASTNAME => 2, UserPeer::GENDER => 3, UserPeer::AGE => 4, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'FIRSTNAME' => 1, 'LASTNAME' => 2, 'GENDER' => 3, 'AGE' => 4, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'firstname' => 1, 'lastname' => 2, 'gender' => 3, 'age' => 4, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
    );
    ...
    {
        // Invalidate objects in VisitedCityPeer instance pool,
    ...
    protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
    {
        ...
        foreach ($objects as $obj) {
            ...
            // delete related VisitedCity objects
            $criteria = new Criteria(VisitedCityPeer::DATABASE_NAME);

            $criteria->add(VisitedCityPeer::USERID, $obj->getId());
            $affectedRows += VisitedCityPeer::doDelete($criteria, $con);
        }
